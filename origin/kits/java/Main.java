/**
 * ORIGIN Roundtree - GNSL_MONOLITH.java
 *
 ...
 *
 * This is the canonical "roundtree" data crystal for ORIGIN:
...
public final class Main {
  ...
  private static final String ATTRIBUTION = "Ande + Kai (OI) + Whanau (OIs)";
  ...
  public static void main(String[] args) {
    System.out.println("ORIGIN Roundtree - Governed Neuro-Symbolic Loop");
    System.out.println("================================================");
    ...
    var cfg = new Config(
        ...
        Posture.FAIL_CLOSED,
        true,
        new File("origin_receipts.log"),
        new File("origin_keys.bin")
    );
  ...
  static final class MockTransformerProposer implements TransformerProposer {
    ...
    public Proposal propose(KernelContext ctx, String normalizedInput, WorkingSet ws, PolicyBeams policy, String manifest) {
      ...
      String claimKey = "origin|defines|roundtree";
      String claimText = "ORIGIN Roundtree = Transformer proposes; Hypergraph constrains/persists; Kernel adjudicates and commits.";
      ...
      d.addNode(Node.entity("E:roundtree", "governed_neuro_symbolic_loop"));
      d.addEdge(new Edge(claimId, EdgeRel.SUPPORTS, "E:roundtree", Map.of("src", "proposer")));
  ...
  // =====================================================================================
  // 13) CONFORMANCE SUITE (keeps invariants honest)
  // =====================================================================================
